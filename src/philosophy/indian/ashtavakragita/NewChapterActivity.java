...
public class NewChapterActivity extends Activity implements TextView.OnEditorActionListener {
	...
	public static final int NUM_CHAPTERS = 20;
	static final String logTag = "Ashtavakra";
	...
	private void readInVerses() {
		...
		for (int i=0; i <= NUM_CHAPTERS; ++i)
		{
		  ...
		  try {
		       ...
		       int resid = getResources().getIdentifier(rName.toString(), "raw", "philosophy.indian.ashtavakragita");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String message = intent.getStringExtra(Ashtavakra.CHAPTER_NUMBER);
        ...
        if (currentChapState != 0)
        {
          ...
          chapNumDisp.setText(Ashtavakra.plainChapters[currentChapState]);
          chapNumTxt.setVisibility(View.GONE);
          
        } else
        {
        		titleTxt.setTextSize(30.0f);
    			titleTxt.setText("Ashtavakra Gita");
    			verseTxt.setTextSize(12.0f);
    			verseTxt.setText("Discussion between King Janaka and Sage Ashtavakra");
    			ackTxt.setTextSize(12.0f);
    			ackTxt.setText("Translated by Swami Nityaswarupananda (http://www.estudantedavedanta.net/Astavakra-Samhita.pdf)");
